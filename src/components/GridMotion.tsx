              ...
              {Array.from({ length: 7 }, (_, itemIndex) => {
                ...
                return (
                  <div key={itemIndex} className="relative">
                    <div className="relative w-full h-full overflow-hidden p-24 rounded-[10px] bg-[#fff] flex items-center justify-center text-white text-[1.5rem]">
                     <img
                          src={content}
                          alt={`Grid item ${rowIndex * 7 + itemIndex + 1}`}
