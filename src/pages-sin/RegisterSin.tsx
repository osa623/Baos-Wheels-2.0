          ...
          <div className="flex flex-col-reverse lg:flex-row w-full">
            ...
            <div className="w-full lg:w-1/2 relative">
              ...
              <div className="relative z-10 flex flex-col items-center justify-center w-full h-full py-12 px-6">
                <img 
                  src={logo} 
                  alt="Baoswheels Logo" 
                  className="w-40 h-40 md:w-60 md:h-60 lg:w-80 lg:h-80 rounded-full shadow-lg object-cover" 
                />
            ...
            <div className="p-6 w-full rounded-2xl lg:w-full bg-white sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full rounded-md button-hover mt-4"
                  disabled={isLoading}
                >
                  {isLoading ? "Creating Account..." : "Create Account"}
                </Button>

                {/* Social Signup with better spacing */}
                <div className="mt-4">
                  <div className="relative">
                    <div className="absolute inset-0 flex itemscenter">
